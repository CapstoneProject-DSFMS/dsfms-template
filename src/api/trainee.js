...
export const traineeAPI = {
  ...
  // Get all active trainees for enrollment - using GET without filters
  getTraineesForEnrollment: async () => {
    try {
      const response = await apiClient.get('/subjects/active-trainees');
