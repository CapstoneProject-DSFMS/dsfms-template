            ...
            >
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <Form.Group className="mb-3" controlId="email">
                  <Form.Label className="text-white fw-medium" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.5)' }}>Email</Form.Label>
                  <Form.Control
                    type="email"
                    value={email}
                ...
                <Form.Group className="mb-3" controlId="password">
                  <Form.Label className="text-white fw-medium" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.5)' }}>Password</Form.Label>
                  <div className="position-relative">
                    ...
                    <button
                      ...
                      className="position-absolute top-50 translate-middle-y end-0 me-3 btn p-0 border-0 bg-transparent"
                      style={{ width: 24, height: 24 }}
                    >
                      {showPassword ? (
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Z" stroke="#6b7280" strokeWidth="1.5" />
                          <path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" stroke="#6b7280" strokeWidth="1.5" />
                          <line x1="3" y1="3" x2="21" y2="21" stroke="#6b7280" strokeWidth="1.5" />
                        </svg>
                      ) : (
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Z" stroke="#6b7280" strokeWidth="1.5" />
                ...
                <div className="text-end mb-4">
                  <Button variant="link" className="p-0 text-white text-decoration-none" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.5)' }}>
                    Forgot password?
                  </Button>
                </div>
                ...
                <div className="text-center mb-4">
                  <div className="d-flex align-items-center">
                    <hr className="flex-grow-1" style={{ borderColor: 'rgba(255, 255, 255, 0.3)' }} />
                    <hr className="flex-grow-1" style={{ borderColor: 'rgba(255, 255, 255, 0.3)' }} />
                  </div>
                </div>
