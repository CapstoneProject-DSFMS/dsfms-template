...
const AssessmentEventDetailModal = ({ 
  ...
  // This must be BEFORE any early returns to follow React hooks rules
  const { sortedData, sortConfig, handleSort } = useTableSort(Array.isArray(tableData) ? tableData : []);
  ...
  const courseInfo = hasSubject 
    ...
    : (entityType === 'course' ? event.entityInfo : null);
    ...
    >
      ...
      >
        <Tab.Container activeKey={activeTab} onSelect={handleTabSelect}>
          <Nav variant="tabs" className="border-bottom bg-white px-3" style={{ margin: 0, flexShrink: 0 }}>
            <Nav.Item>
              <Nav.Link 
                eventKey="overview"
                className={activeTab === 'overview' ? 'active' : ''}
                style={{
                  color: activeTab === 'overview' ? 'var(--bs-primary)' : '#6c757d',
                  borderBottom: activeTab === 'overview' ? '2px solid var(--bs-primary)' : 'none',
            ...
            <Nav.Item>
              <Nav.Link 
                ...
                style={{
                  color: activeTab === 'trainees' ? 'var(--bs-primary)' : '#6c757d',
                  borderBottom: activeTab === 'trainees' ? '2px solid var(--bs-primary)' : 'none',
          ...
          <Tab.Content style={{ flex: 1, overflow: 'hidden', padding: 0, minHeight: 0, height: '100%', display: 'flex', flexDirection: 'column', margin: 0, position: 'relative' }}>
            {/* Overview Tab */}
            <Tab.Pane 
              eventKey="overview" 
              style={{ 
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', flex: 1, padding: '1.5rem', overflowY: 'auto', minHeight: 0, margin: 0, width: '100%' }}>
                {/* General Information Card */}
                <Card className="shadow-sm" style={{ borderColor: 'var(--bs-neutral-200)', marginBottom: 0 }}>
                  <Card.Header 
                  ...
                  <Card.Body className="p-4" style={{ backgroundColor: '#ffffff' }}>
                    <Row className="g-4">
                      <Col md={6}>
                        {/* Event Information */}
                        <div className="mb-3">
                          <h6 className="mb-3 fw-bold" style={{ fontSize: '1rem', color: '#153a4a', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                            Event Information
                          </h6>
                          <div className="mb-2 d-flex align-items-start assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Event Name:</small>
                            <span className="fw-semibold ms-2 assessment-value" style={{ color: 'var(--bs-dark)' }}>
                              {event.name || '-'}
                            </span>
                          </div>
                          <div className="mb-2 d-flex align-items-start assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Occurrence Date:</small>
                            <span className="ms-2 assessment-value" style={{ color: 'var(--bs-dark)' }}>
                              {formatDate(event.occuranceDate || event.occurrenceDate)}
                            </span>
                          </div>
                          <div className="mb-2 d-flex align-items-center assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Event Status:</small>
                            <Badge bg={getStatusBadgeColor(event.status)} className="ms-2 px-3 py-1 assessment-value">
                              {event.status || '-'}
                            </Badge>
                          </div>
                          <div className="mb-2 d-flex align-items-start assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Total Trainees In Assessments:</small>
                            <span className="fw-semibold ms-2 assessment-value" style={{ color: 'var(--bs-dark)' }}>
                        ...
                        {entityType === 'course' && courseInfo && (
                          <div className="mb-3">
                            ...
                            <div className="mb-2 d-flex align-items-start assessment-info-row">
                              <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Course Name:</small>
                              <span className="fw-semibold ms-2 assessment-value" style={{ color: 'var(--bs-dark)' }}>
                                {courseInfo.name || entityName || '-'}
                              </span>
                            </div>
                            <div className="mb-2 d-flex align-items-center assessment-info-row">
                              <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Course Code:</small>
                              <Badge bg="secondary" className="ms-2 px-2 py-1 assessment-value">
                      ...
                      <Col md={6}>
                        ...
                        {hasSubject && subjectInfo && (
                          <div className="mb-3">
                            ...
                            <div className="mb-2 d-flex align-items-start assessment-info-row">
                              <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Subject Name:</small>
                              <span className="fw-semibold ms-2 assessment-value" style={{ color: 'var(--bs-dark)' }}>
                                {subjectInfo.name || entityName || '-'}
                              </span>
                            </div>
                            <div className="mb-2 d-flex align-items-center assessment-info-row">
                              <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Subject Code:</small>
                              <Badge bg="info" className="ms-2 px-2 py-1 assessment-value">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="mb-2 d-flex align-items-start assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Template Name:</small>
                            <span className="fw-semibold ms-2 assessment-value" style={{ color: 'var(--bs-dark)', wordBreak: 'break-word' }}>
                              {templateName}
                            </span>
                          </div>
                          <div className="mb-2 d-flex align-items-center assessment-info-row">
                            <small className="text-muted assessment-label" style={{ minWidth: '200px', fontWeight: 500 }}>Template Preview:</small>
                            <Button
                        ...
                        <Row className="g-3 mb-4">
                          <Col md={4}>
                            <Card className="shadow-sm h-100 d-flex flex-column">
                              <Card.Body className="text-center d-flex flex-column justify-content-center flex-grow-1">
                                <h3 className="text-primary mb-2">{stats.total}</h3>
                                <p className="text-muted mb-0">Total Trainees</p>
                              </Card.Body>
                            </Card>
                          </Col>
                          <Col md={4}>
                            <Card className="shadow-sm h-100 border-success d-flex flex-column">
                              <Card.Body className="text-center d-flex flex-column justify-content-center flex-grow-1">
                          ...
                          <Col md={4}>
                            <Card className="shadow-sm h-100 border-danger d-flex flex-column">
                              <Card.Body className="text-center d-flex flex-column justify-content-center flex-grow-1">
                        ...
                        {stats.total > 0 && (
                          <div className="mt-4">
                            ...
                            <small className="text-muted mt-2 d-block">
                              {stats.passed} out of {stats.total} trainees passed ({stats.total > 0 ? Math.round((stats.passed / stats.total) * 100) : 0}%)
                            </small>
                          </div>
                        )}
                      </>
            ...
            >
              <div style={{ 
                ...
                <Table hover className="mb-0 table-mobile-responsive" style={{ fontSize: '0.875rem', marginTop: 0 }}>
      ...
      >
        <Modal.Header closeButton style={{ flexShrink: 0 }}>
          <Modal.Title>
            Assessment PDF - {selectedTraineePdf?.trainee?.fullName || 'Trainee'}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ 
          padding: 0, 
