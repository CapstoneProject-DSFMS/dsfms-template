    ...
    return (
      <Container fluid className="py-4">
        <div className="text-center py-5">
          ...
          <p className="mt-2 text-muted">Loading assessment data...</p>
        </div>
      </Container>
    );
  }
          ...
          <Card className="border-0 shadow-sm">
            <Card.Body className="p-0">
              <Tabs defaultActiveKey="pending" className="border-bottom">
                ...
                <Tab eventKey="signature" title="Signature Required">
                  <div className="p-4">
                ...
                <Tab eventKey="completion" title="Section Completion">
                  <div className="p-4">
...
export default TraineeAssessmentView;
