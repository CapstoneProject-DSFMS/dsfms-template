...
const Header = ({ onToggleSidebar }) => {
  ...
  const getTitleFromPath = (path) => {
    ...
    const routes = {
      ...
      '/templates/drafts': 'Draft Templates',
      '/main-menu': 'Main Menu',
      '/system-config': 'Global Fields',
      '/courses/instructed': 'Assigned Courses',
      '/courses/enrolled': 'Enrolled Courses',
      '/assessments/upcoming': 'Upcoming Assessment Events',
      '/assessments/my-assessments': 'Your Assessment Events',
      '/assessments/results': 'Assessment Results',
      '/assessments/signature-required': 'Signature Required Forms',
      '/assessments/completion-required': 'Completion Required Forms',
      '/assessment-events': 'Assessment Events',
      '/reports': 'Incidents / Feedback Reports',
      '/reports/create': 'Incidents / Feedback Reports',
      '/reports/issues': 'Incidents / Feedback Reports',
      '/reports/feedback': 'Incidents / Feedback Reports',
      ...
      '/admin/system-config': 'Global Fields',
      '/academic': 'Academic Dashboard',
      '/academic/dashboard': 'Academic Dashboard',
      '/academic/departments': 'Department Management',
      '/academic/assessment-events': 'Assessment Events',
      '/trainee': 'Trainee Dashboard',
      '/trainee/dashboard': 'Trainee Dashboard',
      '/trainee/academic-details': 'Academic Details',
      '/trainee/enrolled-courses': 'Enrolled Courses',
      '/trainee/signature-required': 'Signature Required Sections',
      '/trainee/completion-required': 'Completion Required Sections',
      '/trainee/your-assessments': 'Your Assessment Events',
      '/trainee/create-incident-feedback-report': 'Issue Reporting',
      '/trainee/assessment-pending/section-completion': 'Completion Required Sections',
      '/trainer': 'Trainer Dashboard',
      '/trainer/dashboard': 'Trainer Dashboard',
      '/trainer/upcoming-assessments': 'Upcoming Assessment Events',
      ...
      '/sqa': 'Issue Reports',
      '/sqa/issues': 'Issue Reports',
      '/sqa/feedback': 'Feedback Reports',
      '/sqa/templates': 'Templates',
